...
@section('content')
    <div class="row-mr-4">
        ...
        <div class="col-sm-12">
            <div class="card">
                <form action="{{ route('admin_reports.store') }}" method="POST">
                    @csrf
                    <div class="form-row">
                        <div class="form-group col-md-4-">
                            <label for="inputState" class="xxx">الفرع</label>

                            <select name="branch_id" id="branch_id" class="form-select SlectBox "
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="status" id="inputState" class="form-control">
                                ...
                                <option value="تسكن">تم التسكين</option>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                    <?php $i = 0; ?>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="9" style="text-align: center">لاتوجد نتائج تطابق عملية البحث
                                                </td>
                                            </tr>
                                        @endforelse
